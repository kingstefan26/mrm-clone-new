...
<InformationPage pagetitle={"DMCA Notice"}>
    <h1>DMCA Notice</h1>
    <p>Since we respect artist and content owner rights, it is MyWebsite’ policy to respond to alleged infringement
        ...
        Service, please notify MyWebsite’ copyright agent as set forth in the DMCA. For your complaint to be valid
        under the DMCA, you must provide the following information in writing:</p>
    ...
    <ol>
        ...
        <li>Information reasonably sufficient to permit MyWebsite to contact you, such as your address, telephone
    ...
    <p><strong>The above information must be submitted via <a href="/contact">Contact</a>. Typically the review process
        will take 48 hours from the time of notification.</strong></p>
